# Test Method 1: Using `width` as HTML Attribute

This method uses `width` as an HTML attribute (not CSS style) on `<th>` and `<td>` elements.
...
<tr>
<td width="180" valign="top"><a href="https://github.com/universal-verification-methodology/apb-uart-uvm-env">apb-uart-uvm-env</a></td>
<td width="350" valign="top">UVM environment for APB based UART (RX-FreeRunning)</td>
...
<td width="80" valign="top"><a href="./docs/apb-uart-uvm-env.md">📄</a></td>
</tr>
<tr>
<td width="180" valign="top"><a href="https://github.com/universal-verification-methodology/Synchronous-FIFO-UVM-TB">Synchronous-FIFO-UVM-TB</a></td>
...
<tr>
<td width="180" valign="top"><a href="https://github.com/universal-verification-methodology/tvip-axi">tvip-axi</a></td>
<td width="350" valign="top">AMBA AXI VIP</td>
<td width="100" valign="top">SystemVerilog</td>
...
<tr>
<td width="180" valign="top"><a href="https://github.com/universal-verification-methodology/UVM-APB_RAL">UVM-APB_RAL</a></td>
<td width="350" valign="top">Example of the use of UVM Register Abstraction Layer in a verification of a simple APB DUT</td>
<td width="100" valign="top">SystemVerilog</td>
